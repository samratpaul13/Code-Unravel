...
componentDidMount(){
    try{
        if (this.props.user!=undefined ){
             ...
             this.setState({userObject:this.props.user,questionObject:{recruiter:this.props.user.user_id}});
            }
            else{
...
componentWillMount(){
    ...
    try{
        if (this.props.user!=undefined ){
            console.log("recruiter id "+this.props.user.user_id)
            if(this.props.user.login_token!=undefined || this.props.user.login_token!=""){
             this.setState({userObject:this.props.user,questionObject:{recruiter:this.props.user.user_id}});
            }
            else{
    ...
    handleSubmit=(e)=>{
        ...
        .then(data=>{
            this.setState({
                ...
                time_limit:'',
                allow_languages:'',
                recruiter:this.state.questionObject.recruiter,
            }
        })
                    ...
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <div className="oprions-grid">
                            ...
                            <strong>Full Score  </strong>
                                     <input type="number" name="max_Score" value={max_Score} onChange={this.onChange} id="maxScore" required/>
                            </div>

                            <div>
                            <strong>Pass Score</strong>
                                     <input type="number" name="pass_score" value={pass_score} onChange={this.onChange} id="passScore" required/>
                            </div>
                        ...
                        <input className="create-question-bu" type="submit" value="Create Question"/>
                    </form>
                    </div>
